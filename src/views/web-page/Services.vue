<template>
	<div class="full-width bg-green-100">
		<div class="items-center mx-auto px-5 pt-24 lg:flex max-w-[1320px]">
			<div class="flex-1">
				<h1 class="font-chivo font-bold lg:text-display-2 md:text-[64px] md:leading-[70px] sm:text-[50px] sm:leading-[58px] text-[40px] leading-[48px] mb-[30px] md:w-[13ch]">
					Building the Work Ecosystem
				</h1>
				<p class="text-quote md:text-lead-lg text-gray-500 pr-[40px] lg:pr-[150px] mb-[44px] md:w-[57ch]">
				...
				<div class="flex w-full gap-[60px]">
					<div class="flex items-start lg:mb-[60px] last:mb-0 gap-[26px]">
						<div class="bg-white rounded-full w-[80px] h-[80px]">
							<img class="h-full w-full object-cover p-[18px]" src="./assets/images/icons/icon-waves.svg" alt="icon" />
						</div>
						<div class="flex-1">
							<h2 class="font-bold font-chivo text-[25px] leading-[30px] md:text-heading-3 text-green-900 mb-[5px]">
								+12k
							</h2>
					...
					<div class="flex items-start lg:mb-[60px] last:mb-0 gap-[26px]">
						<div class="bg-white rounded-full w-[80px] h-[80px]">
							<img class="h-full w-full object-cover p-[18px]" src="./assets/images/icons/icon-pine.svg" alt="icon" />
						</div>
						<div class="flex-1">
							<h2 class="font-bold font-chivo text-[25px] leading-[30px] md:text-heading-3 text-green-900 mb-[5px]">
								+68
			...
			<div class="hidden relative h-auto self-end lg:block min-w-[680px]">
				<div class="absolute bottom-0 translate-x-[-120px]">
					<img class="h-full w-full object-cover" src="./assets/images/hero-services-1.png" alt="Agon" />
				</div><img class="absolute animate-float max-w-[300px] bottom-[336px] left-[-28%]" src="./assets/images/bussiness-card.png" alt="Agon" />
			</div>
		</div>
	</div>
</template>